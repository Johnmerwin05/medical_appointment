                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <?php
                                                ...
                                                $query = "SELECT id FROM active WHERE doctor = '$doctor' ORDER BY id";  
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <?php
                                                ...
                                                $query = "SELECT id FROM appointments WHERE doctor = '$doctor' ORDER BY id";
                                                $query_run = mysqli_query($conn, $query);
                                                $row = mysqli_num_rows($query_run);
                                                echo $row.'</h4>';
                                            ?>  </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <?php
                                                ...
                                                $query = "SELECT id FROM history WHERE doctor = '$doctor' ORDER BY id";
                                                $query_run = mysqli_query($conn, $query);
                                                $row = mysqli_num_rows($query_run);
                                                echo $row.'</h4>';
                                            ?>  </div>
...
<div class="col-xl-8 col-lg-7">
    ...
    <div class="card shadow mb-4">
        ...
        <?php
            include '../connection/database.php';
            $sql = "SELECT COUNT(*) as total FROM history WHERE department = 'OB/GYN'  AND doctor = '$doctor'";
            $result = mysqli_query($conn, $sql);
            $row = mysqli_fetch_assoc($result);
            $stage1 = $row['total'];

            $sql = "SELECT COUNT(*) as total FROM history WHERE department = 'Pediatrics'  AND doctor = '$doctor'";
            $result = mysqli_query($conn, $sql);
            $row = mysqli_fetch_assoc($result);
            $stage2 = $row['total'];

            $sql = "SELECT COUNT(*) as total FROM history WHERE department = 'Cardiology'  AND doctor = '$doctor'";
            $result = mysqli_query($conn, $sql);
            $row = mysqli_fetch_assoc($result);
            $stage3 = $row['total'];

            $sql = "SELECT COUNT(*) as total FROM history WHERE department = 'Dermatology'  AND doctor = '$doctor'";
            $result = mysqli_query($conn, $sql);
            $row = mysqli_fetch_assoc($result);
            $stage4 = $row['total'];

            $sql = "SELECT COUNT(*) as total FROM history WHERE department = 'Orthopedics'  AND doctor = '$doctor'";
            $result = mysqli_query($conn, $sql);
            $row = mysqli_fetch_assoc($result);
            $stage5 = $row['total'];
...
<div class="col-xl-4 col-lg-5">
    ...
    <?php
    include '../connection/database.php';
        $sql = "SELECT COUNT(*) as total FROM history WHERE gender = 'Male' AND doctor = '$doctor'";
        $result = mysqli_query($conn, $sql);
        $row = mysqli_fetch_assoc($result);
        $male = $row['total'];

        $sql = "SELECT COUNT(*) as total FROM history WHERE gender = 'Female' AND doctor = '$doctor'";
        $result = mysqli_query($conn, $sql);
        $row = mysqli_fetch_assoc($result);
        $female = $row['total'];
