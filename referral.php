    ...
    <div class="row">
        <div class="col-md-4 border-right" id="head">
            ...
            <?php
                    ...
                    $query="SELECT * FROM referral_data WHERE ticket = '$ticket'";  
                ...
                ?>
                <img id="logo" class="rounded-circle mt-5" width="150px" src="admin/uploads/<?=$datass['logo'];?>">               
        ...
        <div class="col-md-8 border-right">
            <div class="p-3 py-5">
                <div class="d-flex justify-content-between align-items-center mb-3" id="name">
                    <h4 class="text-right" id="title">Medical Referral Letter</h4>
                </div>
                ...
                <div class=" mb-2">
                    <p class="text-black-50" style="margin-bottom: -1px;"><?= $data['ref_doctorname']; ?></p>
                    <p class="text-black-50" style="margin-bottom: -1px;"><?= $data['ref_clinic']; ?></p>
                    <p class="text-black-50" style="margin-bottom: -1px;"><?= $data['ref_phone']; ?></p>
                    <p class="text-black-50"><?= $data['ref_email']; ?></p>
                <br><br>

                <p class="text-black-50">Dear <?= $data['ref_doctorname']; ?>,</p>

                <p class="text-black-50">I am writing to refer my patient, <span><?= $data['name']; ?></span> for the reason of <span><?= $data['ref_reason']; ?></span> </p>



                <p class="text-black-50">Please feel free to contact me if you require any further information about <span><?= $data['name']; ?></span> or [his/her] medical history. I look forward to hearing from you soon and appreciate your attention to this referral.</p>
<br><br>
                <p class="text-black-50">Sincerely,</p>
                <img width="150px" src="admin/uploads/<?=$datass['E_signature'];?>"> 
                <p class="text-black-50" style="margin-top:-3%;"><?= $data['doctor']; ?></p>
