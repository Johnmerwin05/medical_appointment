    ...
    <section id="doctors" class="doctors">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Doctors</h2>
          <p>Pila Medical Center is renowned for its team of highly skilled and experienced doctors. The center is dedicated to providing the highest quality medical care to its patients and ensuring their well-being. The doctors at Pila Medical Center are renowned for their expertise and commitment to providing top-notch medical care.</p>
        </div>
        ...
        ?>
          ...
          <div class="col-lg-6">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="admin/uploads/<?= $data['profile']; ?>" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4><?= $data['doctor_name']; ?></h4>
                <span><?= $data['doctor_specialization']; ?></span>
                <p><?= $data['info']; ?></p>
                <div class="social">
